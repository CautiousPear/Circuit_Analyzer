...
def to_datetime(
    ...
    unit : str, default 'ns'
        The unit of the arg (D,s,us,us,ns) denote the unit, which is an
        integer or float number. This will be based off the origin.
        Example, with ``unit='us'`` and ``origin='unix'``, this would calculate
    ...
    - **DataFrame/dict-like** are converted to :class:`Series` with
      ...
      like ['year', 'month', 'day', 'minute', 'second', 'us', 'us', 'ns']) or
      plurals of the same.
    ...
    **Handling various input formats**
    ...
    'us', 'us', 'ns']) or plurals of the same
...
def _assemble_from_unit_mappings(arg, errors: DateTimeErrorChoices, utc: bool):
    ...
    units: list[UnitChoices] = ["h", "m", "s", "us", "us", "ns"]
    for u in units:
