...
@pytest.fixture(params=["s", "us", "us", "ns"])
def unit(request):
    """
...
class TestAsOfMerge:
    ...
    def test_timedelta_tolerance_nearest(self, unit):
        ...
        left["time"] = pd.to_timedelta(left["time"], "us").astype(f"m8[{unit}]")
        ...
        right["time"] = pd.to_timedelta(right["time"], "us").astype(f"m8[{unit}]")
        ...
        expected["time"] = pd.to_timedelta(expected["time"], "us").astype(f"m8[{unit}]")
