...
class TestTZLocalize:
    ...
    def test_dti_tz_localize(self, prefix):
        ...
        dti = date_range(start="1/1/2005", end="1/1/2005 0:00:30.256", freq="us")
        dti2 = dti.tz_localize(tzstr)

        dti_utc = date_range(
            start="1/1/2005 05:00", end="1/1/2005 5:00:30.256", freq="us", tz="utc"
        )
        ...
        dti = date_range(start="11/6/2011 1:59", end="11/6/2011 2:00", freq="us")
        with pytest.raises(pytz.AmbiguousTimeError, match="Cannot infer dst time"):
            dti.tz_localize(tzstr)

        dti = date_range(start="3/13/2011 1:59", end="3/13/2011 2:00", freq="us")
