...
class TestFromArrays(ConstructorTests):
    ...
    def test_from_arrays_mismatched_datetimelike_resos(self, interval_cls):
        ...
        right = date_range("2017-01-01", periods=3, unit="us")
        result = interval_cls.from_arrays(left, right)
        expected = interval_cls.from_arrays(left.as_unit("us"), right)
        ...
        expected2 = interval_cls.from_arrays(left2.as_unit("us"), right2)
        ...
        expected3 = interval_cls.from_arrays(left3.as_unit("us"), right3)
