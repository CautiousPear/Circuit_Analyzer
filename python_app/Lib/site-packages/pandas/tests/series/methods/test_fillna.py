...
class TestSeriesFillNA:
    ...
    def test_datetime64_fillna_mismatched_reso_no_rounding(self, tz, scalar):
        ...
        vec = date_range(item, periods=3, unit="us")

        exp_dtype = "M8[us]" if tz is None else "M8[us, UTC]"
    ...
    def test_timedelta64_fillna_mismatched_reso_no_rounding(self, scalar):
        ...
        vec = timedelta_range(item, periods=3, unit="us")

        expected = Series([item, tdi[1], tdi[2]], dtype="m8[us]")
    ...
    def test_fillna_dt64_non_nao(self):
        ...
        val = np.datetime64("1975-04-05", "us")
