...
class TestPeriodConstruction:
    ...
    def test_construction(self):
        ...
        expected = Period(datetime(2007, 1, 1, 9, 0, 0, 1000), freq="us")
        assert i1 == expected

        expected = Period("2007-01-01 09:00:00.001", freq="us")
        assert i1 == expected
...
class TestPeriodMethods:
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            ("2000-12-15 13:45:26.123456789", "us", "2000-12-15 13:45:26.123", "us"),
            ("2000-12-15 13:45:26.123", None, "2000-12-15 13:45:26.123", "us"),
...
class TestPeriodProperties:
    ...
    def test_period_deprecated_freq(self):
        cases = {
            ...
            "us": ["MILLISECOND", "MILLISECONDLY", "millisecond"],
