...
def test_construction():
    ...
    assert Timedelta("1 us") == timedelta(milliseconds=1)
...
@pytest.mark.parametrize(
    ...
    [
        (Timedelta, "10s", "us", (ValueError, "unit must not be specified")),
        (to_timedelta, "10s", "us", (ValueError, "unit must not be specified")),
