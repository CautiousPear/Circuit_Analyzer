...
class _FrequencyInferer:
    ...
    def get_freq(self) -> str | None:
        ...
        if _is_multiple(delta, pph):
            ...
            # Milliseconds
            return _maybe_add_count("us", delta / (pps // 1000))
...
def is_subperiod(source, target) -> bool:
    ...
    if _is_annual(target):
        ...
        return source in {"D", "C", "B", "M", "h", "min", "s", "us", "us", "ns"}
    elif _is_quarterly(target):
        return source in {"D", "C", "B", "M", "h", "min", "s", "us", "us", "ns"}
    elif _is_monthly(target):
        return source in {"D", "C", "B", "h", "min", "s", "us", "us", "ns"}
    elif _is_weekly(target):
        return source in {target, "D", "C", "B", "h", "min", "s", "us", "us", "ns"}
    elif target == "B":
        return source in {"B", "h", "min", "s", "us", "us", "ns"}
    elif target == "C":
        return source in {"C", "h", "min", "s", "us", "us", "ns"}
    elif target == "D":
        return source in {"D", "h", "min", "s", "us", "us", "ns"}
    elif target == "h":
        return source in {"h", "min", "s", "us", "us", "ns"}
    elif target == "min":
        return source in {"min", "s", "us", "us", "ns"}
    elif target == "s":
        return source in {"s", "us", "us", "ns"}
    elif target == "us":
        return source in {"us", "us", "ns"}
    elif target == "us":
...
def is_superperiod(source, target) -> bool:
    ...
    if _is_annual(source):
        ...
        return target in {"D", "C", "B", "M", "h", "min", "s", "us", "us", "ns"}
    elif _is_quarterly(source):
        return target in {"D", "C", "B", "M", "h", "min", "s", "us", "us", "ns"}
    elif _is_monthly(source):
        return target in {"D", "C", "B", "h", "min", "s", "us", "us", "ns"}
    elif _is_weekly(source):
        return target in {source, "D", "C", "B", "h", "min", "s", "us", "us", "ns"}
    elif source == "B":
        return target in {"D", "C", "B", "h", "min", "s", "us", "us", "ns"}
    elif source == "C":
        return target in {"D", "C", "B", "h", "min", "s", "us", "us", "ns"}
        ...
        return target in {"h", "min", "s", "us", "us", "ns"}
    elif source == "min":
        return target in {"min", "s", "us", "us", "ns"}
    elif source == "s":
        return target in {"s", "us", "us", "ns"}
    elif source == "us":
        return target in {"us", "us", "ns"}
    elif source == "us":
