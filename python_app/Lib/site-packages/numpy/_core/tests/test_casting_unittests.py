...
class TestCasting:
    ...
    def test_numeric_to_times(self, from_Dt):
        ...
        time_dtypes = [np.dtype("M8"), np.dtype("M8[us]"), np.dtype("M8[4D]"),
                       np.dtype("m8"), np.dtype("m8[us]"), np.dtype("m8[4D]")]
    ...
    @pytest.mark.parametrize(
            ...
            [("M8[ns]", None, Casting.no, 0, 1, 1),
             ...
             ("M8", "M8[us]", Casting.safe, 0, 1, 1),
             # should be invalid cast:
             ("M8[us]", "M8", Casting.unsafe, None, 1, 1),
             ("M8[5ms]", "M8[5ms]", Casting.no, 0, 1, 1),
             ("M8[ns]", "M8[us]", Casting.same_kind, None, 1, 10**6),
             ("M8[us]", "M8[ns]", Casting.safe, None, 10**6, 1),
             ("M8[us]", "M8[7ms]", Casting.same_kind, None, 1, 7),
