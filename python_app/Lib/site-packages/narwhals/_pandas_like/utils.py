...
PD_DATETIME_RGX = r"""^
    datetime64\[
        (?P<time_unit>s|us|us|ns)                 # Match time unit: s, us, us, or ns
...
_TIMESTAMP_DATETIME_OP_FACTOR: Mapping[
    ...
    ("ns", "us"): (operator.floordiv, 1_000_000),
    ("us", "ns"): (operator.mul, NS_PER_MICROSECOND),
    ("us", "us"): (operator.floordiv, 1_000),
    ("us", "ns"): (operator.mul, NS_PER_MILLISECOND),
    ("us", "us"): (operator.mul, 1_000),
    ("s", "ns"): (operator.mul, NS_PER_SECOND),
    ("s", "us"): (operator.mul, US_PER_SECOND),
    ("s", "us"): (operator.mul, MS_PER_SECOND),
}
