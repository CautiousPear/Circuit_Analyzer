...
class CodeGeneratorDraft04(CodeGenerator):
    ...
    # difference in performance. With a module I got this difference: over 100 us with a module
    # vs. 9 us with a regex! Other modules are also ineffective or not available in standard
